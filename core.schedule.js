...
// Split from app.core.js. Load this AFTER core.sync.js and BEFORE core.stats.js, core.ui.js, app.game.js, and app.boot.js.
...
// The supplied ZIP called this helper but did not define it.
function createDayEntryFromLayout(layout, dayNumber) {
  return {
    day: dayNumber,
    byeTeam: layout.byeTeam,
    games: layout.pairings.map(([away, home], index) => createSeriesEntry(away, home, index + 1))
  };
}
...
async function endSeriesEarly(dayIndex, seriesIndex) {
	if (!hasFullAppAccess()) {
		alert("Open the main menu to edit the schedule.");
		return;
	}
